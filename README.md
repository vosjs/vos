...
| [`@vosjs/shared`](./packages/shared)           | [![npm](https://img.shields.io/npm/v/%40vosjs%2Fshared)](https://www.npmjs.com/package/@vosjs/shared)           | The small shared layer under the CLI and the studio: the semantic differ, limits, frontmatter, params, the font and music catalogs.                                                                                             |
