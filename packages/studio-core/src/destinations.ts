...
// Source: packages/vos-plugin/schema/channel-specs.json (verified 2026-08-04).
...
export interface Destination {
  ...
  /**
   * Image genre: 'screenshot' = real UI from the take
   * (store policy demands real UX); 'card' = a COMPOSED cover — rendered
   * from the maker's poster program when `vos deliver --poster` has one.
   */
